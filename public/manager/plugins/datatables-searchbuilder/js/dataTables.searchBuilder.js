(function () {
	 ...
	 * type are not widely supported in desktop browsers.
	 *
		...
		_constructor: function () {
			...
			this.dom.input
				...
				.on('keyup.datetime', function () {
					// Update the calendar's displayed value as the user type
	...
	var Criteria = /** @class */ (function () {
	    function Criteria(table, opts, topGroup, index, depth) {
	        ...
	        // Get options from user and any extra conditions/column type defined by plug-ins
