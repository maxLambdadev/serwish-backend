...
@section('panel')
    @include('manager.partials.actionPanel',[
        'createRoute' => 'manager.slider.create',
        'bulkDelete'=>true,
        'bulkDeleteRoute'=> 'manager.slider.bulk.delete',
...
@push('crumbs')
    ...
    <li class="breadcrumb-item active">სლაიდერი</li>
@endpush
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">სლაიდერი</h3>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @foreach($list as $l)
                            <tr id="tr-{{$l->id}}">
                                ...
                                <td>{{$l->id}}</td>
                                <td>{{$l->title}}</td>
                                <td>{!! \Illuminate\Support\Str::limit($l->description,50, '...') !!}</td>
                                <td>
...
{{--                                        <img src="{{asset('/noimage.png)}}" alt="" width="30" height="40">--}}
                                ...
                                <td>
                                    @include('manager.partials.actionButton',[
                                        'editRoute'=>route('manager.slider.edit',['id'=>$l->id]),
                                        'deleteRoute'=>route('manager.slider.destroy',['id'=>$l->id]),
                                    ])
                                </td>
                            </tr>
                        @endforeach
