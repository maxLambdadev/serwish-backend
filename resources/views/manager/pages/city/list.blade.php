...
@section('panel')
    @include('manager.partials.actionPanel',[
        'createRoute' => 'manager.city.create',
        'bulkDelete'=>true,
        'bulkDeleteRoute'=> 'manager.city.bulk.delete',
        'disableEdit'=>true
    ])
@endsection
@section('section-title', 'ქალაქები')

@push('crumbs')
    <li class="breadcrumb-item">მართვა</li>
    <li class="breadcrumb-item active">ქალაქები</li>
@endpush
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">ქალაქები</h3>
            ...
            <div class="card-body table-responsive p-0">
                            ...
                            <tr id="tr-{{$l->id}}">
                                ...
                                <td>
                                    @include('manager.partials.actionButton',[
                                        'editRoute'=>route('manager.city.edit',['id'=>$l->id]),
                                        'deleteRoute'=>route('manager.city.destroy',['id'=>$l->id]),
                                    ])
                                </td>
                            </tr>
                        @endforeach
                ...
                @else
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        {{__('panel.no_records_found',['record'=>'ქალაქები'])}}
                    </div>
                @endif
            </div>
            <!-- /.card-body -->
