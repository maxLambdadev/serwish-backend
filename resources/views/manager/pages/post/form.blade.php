...
@push('crumbs')
    ...
    <li class="breadcrumb-item"><a href="{{route('manager.blog.post.index')}}">სიახლეები</a></li>

    <li class="breadcrumb-item active">სიახლის ფორმა</li>
@endpush
@section('content')

    <div class="col-md-12">
        <form id="quickForm" action="{{route('manager.blog.post.store')}}">
            <input type="hidden" name="redirect" value="{{route('manager.blog.post.index')}}">
                   ...
                   <div class="card card-primary">
                       ...
                       <div class="card-body">
                           ...
                           <x-form.dropzone name="files"
                                            :title="__('isActive')"
                                            :entity="isset($entity) ? $entity : null"
                                            :removeEntity="\App\Models\Blog\Post::class"
